...
/datum/game_mode/proc/add_hog_follower(datum/mind/follower_mind, colour = "No Colour")
	...
	follower_mind.special_role = (colour == "red" ? SPECIAL_ROLE_RED_FOLLOWER : SPECIAL_ROLE_BLUE_FOLLOWER)
...
/datum/game_mode/proc/add_god(datum/mind/god_mind, colour = "No Colour")
	...
	god_mind.special_role = (colour == "red" ? SPECIAL_ROLE_RED_GOD : SPECIAL_ROLE_BLUE_GOD)
