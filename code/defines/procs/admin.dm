...
/proc/fix_ui(var/text)
	text = replacetext(text, "á", "&aacute;")
	text = replacetext(text, "Á", "&Aacute;")
	text = replacetext(text, "a", "&atilde;")
	text = replacetext(text, "A", "&Atilde;")
	text = replacetext(text, "â", "&acirc;")
	text = replacetext(text, "Â", "&Acirc;")
	text = replacetext(text, "r", "&agrave;")
	text = replacetext(text, "R", "&Agrave;")
	text = replacetext(text, "é", "&eacute;")
	text = replacetext(text, "É", "&Eacute;")
	text = replacetext(text, "e", "&ecirc;")
	text = replacetext(text, "E", "&Ecirc;")
	text = replacetext(text, "í", "&iacute;")
	text = replacetext(text, "Í", "&Iacute;")
	text = replacetext(text, "ó", "&oacute;")
	text = replacetext(text, "Ó", "&Oacute;")
	text = replacetext(text, "o", "&otilde;")
	text = replacetext(text, "O", "&Otilde;")
	text = replacetext(text, "ô", "&ocirc;")
	text = replacetext(text, "Ô", "&Ocirc;")
	text = replacetext(text, "ú", "&uacute;")
	text = replacetext(text, "Ú", "&Uacute;")
	text = replacetext(text, "ç", "&ccedil;")
	text = replacetext(text, "Ç", "&Ccedil;")
