...
/client/proc/cmd_admin_dress(var/mob/living/carbon/human/M in mob_list)
	...
	switch(dresscode)
		...
		if("Engineer RIG","CE RIG","Mining RIG","Syndi RIG","Wizard RIG","Medical RIG","Atmos RIG")
			...
			J.turn_on()
			M.equip_to_slot_or_del(new /obj/item/clothing/mask/breath(M), slot_wear_mask)
			equip_special_id(M,get_all_accesses(), "RIG Tester", /obj/item/weapon/card/id) // in the future maybe change ID according to job
			J.Topic(null, list("stat" = 1))
		...
		if("pirate")
			...
			equip_special_id(M,list(access_maint_tunnels), "Pirate", /obj/item/weapon/card/id) //Should pirates have all access?
		...
		if("space pirate")
			...
			M.equip_to_slot_or_del(new /obj/item/weapon/melee/energy/sword/pirate(M), slot_r_hand)
			equip_special_id(M,list(access_maint_tunnels), "Space Pirate", /obj/item/weapon/card/id) //Should pirates have all access?
		...
		if("assassin")
			...
			equip_special_id(M,list(access_maint_tunnels), "Reaper", /obj/item/weapon/card/id/syndicate, "syndie")
		...
		if("nt special ops officer")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/magboots/advance(src), slot_in_backpack)
