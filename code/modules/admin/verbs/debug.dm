...
/client/proc/cmd_admin_dress(var/mob/living/carbon/human/M in mob_list)
	...
	switch(dresscode)
		...
		if("pirate")
			...
			equip_special_id(M,get_all_accesses(), "Pirate", /obj/item/weapon/card/id) //Should pirates have all access?
		...
		if("space pirate")
			...
			M.equip_to_slot_or_del(new /obj/item/weapon/melee/energy/sword/pirate(M), slot_r_hand)
			equip_special_id(M,get_all_accesses(), "Space Pirate", /obj/item/weapon/card/id) //Should pirates have all access?
