...
/obj/item/weapon/book/manual/conveyor
	name = "Nano-it-up U-build series, #9: Build your very own conveyor belt, in SPACE"
	icon_state = "bookEngineering"
	author = "Thomas Robins"
	title = "Build your very own conveyor belt"
	dat = {"<html>
				<head>
					<style>
						h1 {font-size: 15px; margin: 15px 0px 5px;}
				...
				<body>
					...
					You are now the proud owner of the best conveyor set available for space mail order!
					We at Nano-it-up know you love to prepare your own structures without wasting time, so we have devised a special streamlined assembly procedure that puts all other mail-order products to shame!
					Firstly, you need to link the conveyor switch assembly to each of the conveyor belt assemblies.
					After doing so, you simply need to install the belt assemblies onto the floor, et voila, belt built.
					Our special Nano-it-up smart switch will detected any linked assemblies as far as the eye can see!
