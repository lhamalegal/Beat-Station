...
/datum/game_mode/wizard/raginmages/announce()
	var/text = "<B>The current game mode is - Ragin' Mages!</B><br>"
	text += "<B>The <font color='red'>Space Wizard Federation</font> is pissed, help defeat all the space wizards!</B>"
	..(text)
